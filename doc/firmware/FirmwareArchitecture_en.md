...
the combined state of all of them is reported to `inputHub`.
...
Use the `add*()` methods to set up any kind of inputs
(button matrices, rotary encoders, etc) and their pins.
...
8. Map raw button inputs into user-defined inputs,
