...
The market's typical line decoders use addresses that are 3 bits long (decoding to 8 lines). One of these would allow you to use just six pins to achieve 24 inputs.
