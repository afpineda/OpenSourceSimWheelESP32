...
- We are using the button matrix only.
- Matrix wiring is prone to human mistake.
  If something goes weird, check the wiring first.
- For later reference, buttons are named "D1" to "D6",
