...
const gpio_num_t WAKEUP_PINS[] = {GPIO_NUM_27, GPIO_NUM_14};
...
void simWheelSetup()
{
    ...
    inputs::addRotaryEncoder(GPIO_NUM_36, GPIO_NUM_39); // fistButtonNumber=25
    inputs::addRotaryEncoder(GPIO_NUM_34, GPIO_NUM_35); // fistButtonNumber=27
    inputs::addRotaryEncoder(GPIO_NUM_32, GPIO_NUM_33); // fistButtonNumber=29
    inputs::addRotaryEncoder(GPIO_NUM_25, GPIO_NUM_26); // fistButtonNumber=31
    inputs::addDigital(GPIO_NUM_27, true, true);       // fistButtonNumber=33 (Rotary 1)
    inputs::addDigital(GPIO_NUM_14, true, true);       // fistButtonNumber=34 (Rotary 2)
    inputs::addDigital(GPIO_NUM_3, true, true);        // fistButtonNumber=35 (Rotary 3)
